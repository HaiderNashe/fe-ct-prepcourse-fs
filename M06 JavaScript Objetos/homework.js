...
const { numeroMasGrande, obtenerLargoDelArray } = require("../M05 JavaScript Arrays/homework");
...
function crearGato(nombre, edad) {
   ...
   // Retornar el objeto.
   // Tu código:
   let nuevoObjeto = {nombre, edad, meow: function(){ return ("Meow!")}};
   return nuevoObjeto
}
...
function nuevoUsuario(nombre, email, password) {
   ...
   // Retornar el objeto.
   // Tu código:
   let nuevoObjeto = {nombre, email, password}
   return nuevoObjeto
}
